...
public class VungleAndroid
{
	...
	public static void playAd( bool incentivized, string user)
	{
		if( Application.platform != RuntimePlatform.Android )
			return;
	...
	public static void playAdEx( bool incentivized, int orientation, bool large, string user,
	...
	public static void playAdEx( Dictionary<string,object> options)
	{
		...
		_plugin.Call( "playAdEx", MiniJSON.Json.Serialize(options) );
	}
}
#endif
