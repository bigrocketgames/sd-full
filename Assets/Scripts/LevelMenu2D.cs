...
public class LevelMenu2D : Singleton<LevelMenu2D> {
	...
	//TODO - Added by me to access level Manager and move to next scene
	private LevelManager levelManager;
	private SFXManager sfxManager;
	public AudioClip shipChoiceMove;
	...
	void Update () {
		...
		//TODO - Added by me for clarity
		if (_currentItemIndex == 0)
		{
			backButtonObject.SetActive(false);
		}
		else if(_currentItemIndex == itemsList.Count-1)
		{
	...
	public void gotoNextItem()
	{
		...
		{
			//TODO - I added
			sfxManager.PlaySFX(shipChoiceMove);
