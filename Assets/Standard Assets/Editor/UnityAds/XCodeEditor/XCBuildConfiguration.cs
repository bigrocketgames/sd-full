...
namespace UnityEngine.Advertisements.XCodeEditor
{
	public class XCBuildConfiguration : PBXObject
	{
		...
		protected bool AddSearchPaths(string path, string key, bool recursive)
		{
		...
		protected bool AddSearchPaths(PBXList paths, string key, bool recursive)
		{
			bool modified = false;
		...
		public bool AddLibrarySearchPaths(PBXList paths, bool recursive)
		{
			return this.AddSearchPaths(paths, LIBRARY_SEARCH_PATHS_KEY, recursive);
		}

		public bool AddFrameworkSearchPaths(PBXList paths, bool recursive)
		{
